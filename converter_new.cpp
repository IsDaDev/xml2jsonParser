            ...
            if (line.inlineValues.size() > 0 && line.value != "" && line.value != "{") {
                ...
                if (line.value == "{") {
                    ...
                    if (i >= 2 && i + 2 < objects.size() & !line.inlineValues.empty()) {
                        ...
                        // else {
                        //     valuePart = "{" + line.inlineValues[0] + ",\"_Value\":\"\"}]";
                        //     squareBrackets++;
                        // }
                    } else {
                        valuePart = firstPart + "\": \"" + line.value + "\",\n";
...
int main()
{
    ...
    std::string rawData = "<Event xmlns='http://schemas.microsoft.com/win/2004/08/events/event'><System><Provider Name='Microsoft-Windows-Hyper-V-VmSwitch' Guid='{67dc0d66-3695-47c0-9642-33f76f7bd7ad}'/><EventID>291</EventID><Version>0</Version><Level>4</Level><Task>0</Task><Opcode>0</Opcode><Keywords>0x8000000000000080</Keywords><TimeCreated SystemTime='2025-10-22T06:17:01.4277145Z'/><EventRecordID>38081</EventRecordID><Correlation/><Execution ProcessID='4' ThreadID='29548'/><Channel>System</Channel><Computer>DESKTOP-SV73V84</Computer><Security UserID='S-1-5-18'/></System><EventData><Data Name='NicName'>B7379BC2-56C4-4B02-8324-984764F313AE--4B480FFB-2CD7-4F0F-B6AD-B956C0D19EDE</Data><Data Name='NicFName'></Data><Data Name='OldNicIPv4RscEnabled'>1</Data><Data Name='OldNicIPv6RscEnabled'>1</Data><Data Name='NewNicIPv4RscEnabled'>0</Data><Data Name='NewNicIPv6RscEnabled'>0</Data><Data Name='RscStateModifiedReason'>6</Data></EventData></Event>";
